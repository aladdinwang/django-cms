...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ZipUpload'
        db.create_table(u'cms_zipupload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('cms', ['ZipUpload'])

        # Adding field 'CMS_Template.name'
        db.add_column(u'cms_cms_template', 'name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ZipUpload'
        db.delete_table(u'cms_zipupload')

        # Deleting field 'CMS_Template.name'
        db.delete_column(u'cms_cms_template', 'name')
    ...
    models = {
        ...
        'cms.cms_template': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '500', 'blank': 'True'})
        },
        'cms.cmsplugin': {
        ...
        'cms.page': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'webapp': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
