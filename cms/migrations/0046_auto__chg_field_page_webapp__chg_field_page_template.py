...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.webapp'
        db.alter_column(u'cms_page', 'webapp', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Page.webapp'
        db.alter_column(u'cms_page', 'webapp', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Page.template'
        db.alter_column(u'cms_page', 'template', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'cms.page': {
            ...
            'template': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
