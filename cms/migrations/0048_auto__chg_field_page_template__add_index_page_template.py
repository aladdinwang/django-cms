...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cms_page', 'template', self.gf('django.db.models.fields.related.ForeignKey')(db_column='template', to=orm['cms.CMS_Template']))
        # Adding index on 'Page', fields ['template']
        db.create_index(u'cms_page', ['template'])


    def backwards(self, orm):
        # Removing index on 'Page', fields ['template']
        db.delete_index(u'cms_page', ['template'])


        # Changing field 'Page.template'
        db.alter_column(u'cms_page', 'template', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        'cms.page': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'db_column': "'template'", 'to': "orm['cms.CMS_Template']"}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
