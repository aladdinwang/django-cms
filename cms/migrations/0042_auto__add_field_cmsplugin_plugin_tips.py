...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CMSPlugin.plugin_tips'
        db.add_column(u'cms_cmsplugin', 'plugin_tips',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CMSPlugin.plugin_tips'
        db.delete_column(u'cms_cmsplugin', 'plugin_tips')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'plugin_tips': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
