...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CMS_Template'
        db.create_table(u'cms_cms_template', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cms_template', self.gf('filebrowser.fields.FileBrowseField')(max_length=500, null=True, blank=True)),
        ))
        db.send_create_signal('cms', ['CMS_Template'])


    def backwards(self, orm):
        # Deleting model 'CMS_Template'
        db.delete_table(u'cms_cms_template')
    ...
    models = {
        ...
        'cms.cms_template': {
            ...
            'cms_template': ('filebrowser.fields.FileBrowseField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'cms.cmsplugin': {
