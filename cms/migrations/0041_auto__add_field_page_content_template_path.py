...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.content_template_path'
        db.add_column(u'cms_page', 'content_template_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.content_template_path'
        db.delete_column(u'cms_page', 'content_template_path')
