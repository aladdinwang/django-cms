...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cms_page', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, db_column='template', to=orm['cms.CMS_Template']),
                      keep_default=False)
    ...
    models = {
        ...
        'cms.page': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'db_column': "'template'", 'to': "orm['cms.CMS_Template']"}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
