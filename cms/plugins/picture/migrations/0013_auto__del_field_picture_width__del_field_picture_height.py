...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cmsplugin_picture', 'width')

        # Deleting field 'Picture.height'
        db.delete_column(u'cmsplugin_picture', 'height')


    def backwards(self, orm):
        # Adding field 'Picture.width'
        db.add_column(u'cmsplugin_picture', 'width',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Picture.height'
        db.add_column(u'cmsplugin_picture', 'height',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
