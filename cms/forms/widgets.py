...
# from @wej the page template eidtor widget
class ContentTemplateEditor(Widget):
    ...
    def render(self, name, value, attrs=None):
        # should add 'add' context variable?
        # print self.attrs['content_template_url']
        context = {
            'copy_languages': self.attrs['copy_languages'],
            'language': self.attrs['language'],
            'content_template_url': self.attrs['content_template_url'],
            }
        return mark_safe(render_to_string(
                'admin/cms/page/widgets/content_template_editor.html', context))
